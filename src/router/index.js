...
export default new Router({
  routes: [
    ...
    { path: "/miniprogram", name: "miniprogram", component: miniprogram },
    {
      path: "/schoolLogin",
      name: "校园登录",
      component: educationPaymentSchoolLogin
    },

    {
      ...
      children: [
        ...
        { path: "/richTextList", name: "文章列表", component: richTextList },
        {
          ...
          name: "文件库",
          component: uiConsoleGallery
        },
        { path: "/articleUpdate", name: "更新文章", component: articleUpdate },
        { path: "/wxuser", name: "微信用户", component: wxuser },
        //单商家房产中介通用模板
        {
          path: "/houseAgentOverview",
          name: "信息总览",
          component: houseAgentOverview
        },
        {
          path: "/houseAgentRecommend",
          name: "首页推荐",
          component: houseAgentRecommend
        },
        {
          path: "/houseAgentHandRoom",
          name: "二手房列表",
          component: houseAgentHandRoom
        },
        {
          path: "/houseAgentHandRoomAdd",
          name: "新增二手房",
          component: houseAgentHandRoomAdd
        },
        {
          path: "/houseAgentNewHouse",
          name: "新房列表",
          component: houseAgentNewHouse
        },
        {
          path: "/houseAgentNewHouseAdd",
          name: "新增新房",
          component: houseAgentNewHouseAdd
        },
        {
          path: "/houseAgentHandRoomUpdate",
          name: "二手房修改",
          component: houseAgentHandRoomUpdate
        },
        {
          path: "/houseAgentNewHouseUpdate",
          name: "新房修改",
          component: houseAgentNewHouseUpdate
        },
        {
          path: "/houseAgentRentRoomAdd",
          name: "新增租房",
          component: houseAgentRentRoomAdd
        },
        {
          path: "/houseAgentRentRoom",
          name: "租房列表",
          component: houseAgentRentRoom
        },
        {
          path: "/houseAgentRentRoomUpdate",
          name: "修改租房信息",
          component: houseAgentRentRoomUpdate
        },
        {
          path: "/houseAgentDetailRecommend",
          name: "详情页推荐规则",
          component: houseAgentDetailRecommend
        },
        {
          path: "/houseAgentUserPublish",
          name: "用户发布信息",
          component: houseAgentUserPublish
        },
        //教育缴费
        {
          path: "/educationPaymentOverview",
          name: "信息总览",
          component: educationPaymentOverview
        },
        {
          path: "/educationPaymentSchoolList",
          name: "校园列表",
          component: educationPaymentSchoolList
        },
        {
          path: "/educationPaymentSchoolAdd",
          name: "新增校园",
          component: educationPaymentSchoolAdd
        },
        {
          path: "/educationPaymentstudentList",
          name: "学生列表",
          component: educationPaymentstudentList
        },
        {
          path: "/educationPaymentBankCardList",
          name: "银行卡列表",
          component: educationPaymentBankCardList
        },
        {
          path: "/educationPaymentPayItemList",
          name: "缴费项列表",
          component: educationPaymentPayItemList
        },
        {
          path: "/educationPaymentPaymentList",
          name: "学生缴费列表",
          component: educationPaymentPaymentList
        }
      ]
    },
    //缴费校园版面
    {
      path: "/school",
      name: "school",
      component: educationPaymentSchoolMain,
      children: [
        {
          path: "/educationPaymentSchoolStudentsAdd",
          name: "添加学生",
          component: educationPaymentSchoolStudentsAdd
        },
        {
          path: "/educationPaymentSchoolStudentsList",
          name: "学生列表",
          component: educationPaymentSchoolStudentsList
        },
        {
          path: "/educationPaymentSchoolOverview",
          name: "信息总览",
          component: educationPaymentSchoolOverview
        },
        {
          path: "/educationPaymentSchoolBankCardList",
          name: "银行卡列表",
          component: educationPaymentSchoolBankCardList
        },
        {
          path: "/educationPaymentSchoolPaymentList",
          name: "学生缴费列表",
          component: educationPaymentSchoolPaymentList
        },
        {
          path: "/educationPaymentSchoolPaymentAdd",
          name: "添加缴费",
          component: educationPaymentSchoolPaymentAdd
        },
        {
          path: "/educationPaymentSchoolPayItemList",
          name: "缴费项列表",
          component: educationPaymentSchoolPayItemList
        }
      ]
    }
  ]
